...
<body>
  ...
  <div id="cortes">
    <a href="./cortes/corte.php"><img id="imgcorte" src="../imagens/cortes.jpg">
      <h1 id="txtCorte">CORTES</h1>
    </a>
  </div>
  <div id="horarios">
    <a href="../visao/horario/meuhorario.php"> <img id="imghorario" src="../imagens/horario.jpg">
      <h1 id="txtHorario">HORARIOS</h1>
    </a>
  </div>
</body>